    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="交流内容" prop="jiaoliuneirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jiaoliuneirong" label="交流内容" prop="jiaoliuneirong">
                    <span v-html="ruleForm.jiaoliuneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.jiaoliuneirong = this.ruleForm.jiaoliuneirong.replace(reg,'../../../springboot8k3eu/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
