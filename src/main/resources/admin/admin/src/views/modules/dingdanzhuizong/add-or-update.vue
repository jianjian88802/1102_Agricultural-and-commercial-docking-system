<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="交接时间" prop="jiaojieshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.jiaojieshijian" 
                type="datetime"
                :readonly="ro.jiaojieshijian"
                placeholder="交接时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiaojieshijian" label="交接时间" prop="jiaojieshijian">
              <el-input v-model="ruleForm.jiaojieshijian" 
                placeholder="交接时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="交货内容" prop="jiaohuoneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="交货内容"
                  v-model="ruleForm.jiaohuoneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiaohuoneirong" label="交货内容" prop="jiaohuoneirong">
                    <span>{{ruleForm.jiaohuoneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	xingming : false,
	shouji : false,
	jiaohuoneirong : false,
	jiaojieshijian : false,
	zhanghao : false,
	maijiaxingming : false,
      ...
      rules: {
          ...
          jiaohuoneirong: [
                { required: true, message: '交货内容不能为空', trigger: 'blur' },
          ],
          jiaojieshijian: [
          ],
          zhanghao: [
  ...
  created() {
	this.ruleForm.jiaojieshijian = this.getCurDateTime()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shouji = true;
          ...
          if(o=='jiaohuoneirong'){
            this.ruleForm.jiaohuoneirong = obj[o];
	    this.ro.jiaohuoneirong = true;
            continue;
          }
          if(o=='jiaojieshijian'){
            this.ruleForm.jiaojieshijian = obj[o];
	    this.ro.jiaojieshijian = true;
            continue;
          }
          if(o=='zhanghao'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `dingdanzhuizong/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.dingdanzhuizongCrossAddOrUpdateFlag = false;
						 this.parent.search();
